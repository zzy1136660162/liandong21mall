...
-- ----------------------------
-- Table structure for xp_sample_applications (样品申请表)
-- ----------------------------
DROP TABLE IF EXISTS `xp_sample_applications`;
CREATE TABLE `xp_sample_applications` (
  ...
  `ship_status` tinyint DEFAULT '0' COMMENT '寄出状态：0-未寄出，1-已寄出，2-已签收',
