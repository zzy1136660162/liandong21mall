...
<div class="product-detail">
    ...
    <ul>
        ...
        <li>请置于儿童接触不到的地方</li>
                ...
                'good_rate': '98',
                'review_count': 326,
                'review_tags': ['补水效果好', '吸收快', '味道清香', '包装精美'],
                'shop_name': '美妆专营店',
                'shop_logo': 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=100&h=100&fit=crop',
                'shop_sales': '12580',
                'shop_score': '4.9',
                'product_score': '4.8',
                'logistics_score': '4.7',
                'service_score': '4.9',
                'daren_count': 45,
                'tuanzhang_name': '美妆达人小美',
                'tuanzhang_avatar': 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop',
                'tuanzhang_desc': '专注美妆护肤10年，专业推荐好产品',
                'tags': ['热销', '新品', '包邮'],
                'status': 1,
                'is_hot': 1,
                'is_new': 1,
...
<div class="product-detail">
    ...
    <ol>
        ...
        <li>直至完全吸收即可</li>
                ...
                'commission_amount': 23.88,
                'good_rate': '97',
                'review_count': 456,
                'review_tags': ['美白效果好', '不油腻', '吸收快', '味道好闻'],
                'shop_name': '护肤小铺',
                'shop_logo': 'https://images.unsplash.com/photo-1560343090-f0409e92791a?w=100&h=100&fit=crop',
                'shop_sales': '8920',
                'shop_score': '4.8',
                'product_score': '4.7',
                'logistics_score': '4.8',
                'service_score': '4.9',
                'daren_count': 38,
                'tuanzhang_name': '护肤达人阿雅',
                'tuanzhang_avatar': 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop',
                'tuanzhang_desc': '专业护肤顾问，为您推荐最适合的产品',
                'tags': ['美白', '保湿', '热卖'],
                'status': 1,
                'is_hot': 1,
                'is_new': 0,
...
<div class="product-detail">
    ...
    <ol>
        ...
        <li>用纸巾轻按，去除多余油脂</li>
                ...
                'commission_amount': 23.04,
                'good_rate': '99',
                'review_count': 678,
                'review_tags': ['颜色好看', '持久度高', '不干燥', '包装精美'],
                'shop_name': '彩妆集合店',
                'shop_logo': 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=100&h=100&fit=crop',
                'shop_sales': '15670',
                'shop_score': '4.9',
                ...
                'service_score': '4.9',
                'daren_count': 67,
                'tuanzhang_name': '彩妆达人琳琳',
                'tuanzhang_avatar': 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop',
                'tuanzhang_desc': '专业彩妆师，为您打造完美妆容',
                'tags': ['热销', '持久', '显白'],
                'status': 1,
                'is_hot': 1,
                'is_new': 1,
...
<div class="product-detail">
    ...
    <ol>
        ...
        <li>用清水彻底冲洗干净</li>
                ...
                'commission_amount': 8.90,
                'good_rate': '98',
                'review_count': 892,
                'review_tags': ['清洁力强', '温和不刺激', '泡沫丰富', '味道好闻'],
                'shop_name': '个护专营店',
                'shop_logo': 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=100&h=100&fit=crop',
                'shop_sales': '21340',
                'shop_score': '4.8',
                ...
                'service_score': '4.9',
                'daren_count': 89,
                'tuanzhang_name': '个护达人小芳',
                'tuanzhang_avatar': 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop',
                'tuanzhang_desc': '专注个护产品，为您推荐好用的洗护用品',
                'tags': ['清洁', '温和', '热卖'],
                'status': 1,
                'is_hot': 1,
                'is_new': 0,
...
<div class="product-detail">
    ...
    <p>适合所有人群，特别是注重健康饮食、需要控制体重的人群</p>
                ...
                'good_rate': '97',
                'review_count': 1234,
                'review_tags': ['口感好', '营养丰富', '有机健康', '方便食用'],
                'shop_name': '健康食品店',
                'shop_logo': 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=100&h=100&fit=crop',
                'shop_sales': '28930',
                'shop_score': '4.9',
                ...
                'service_score': '4.8',
                'daren_count': 123,
                'tuanzhang_name': '健康达人小健',
                'tuanzhang_avatar': 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop',
                'tuanzhang_desc': '专注健康食品，为您推荐营养美味',
                'tags': ['有机', '健康', '营养'],
                'status': 1,
                'is_hot': 1,
                'is_new': 1,
